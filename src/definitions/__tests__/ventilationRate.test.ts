...
import ventilationRate, {VentilationRateSystems, VentilationRateUnits} from '../ventilationRate'

test('ACH to ACM', () => {
    const convert = configureMeasurements<'ventilationRate', VentilationRateSystems, VentilationRateUnits>({
        ventilationRate,
    });
