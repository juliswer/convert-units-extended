...
export type EnergyConsumptionPerAreaUnits = EnergyConsumptionPerAreaMetricUnits | EnergyConsumptionPerAreaImperialUnits
...
export type EnergyConsumptionPerAreaImperialUnits = 'kWh/ft2' | 'kWh/in2' | 'kBtu/ft2'
...
const measure: Measure<EnergyConsumptionPerAreaSystems, EnergyConsumptionPerAreaUnits> = {
    systems: {
      metric,
      imperial,
    },
