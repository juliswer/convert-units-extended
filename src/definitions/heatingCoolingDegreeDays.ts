...
export type HeatingCoolingDegreeDaysSIUnits = 'degF-days' | 'degC-days' | 'degK-days';
...
const measure: Measure<HeatingCoolingDegreeDaysSystems, HeatingCoolingDegreeDaysUnits> = {
    systems: {
      SI,
    },
};
